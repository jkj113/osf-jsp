...
public class PBoardDAOImpl implements PBoardDAO {
	...
	private static final String SELECT_PBOARD = "select pb_num, pb_title, pb_content, pb_credat, pb_cretim, pb_real_path, pb_file_path from photo_board where pb_num=?";
	@Override
	public int insertPBoard(Map<String, String> pBoard) {
		try {
			System.out.println(INSERT_PBOARD);
